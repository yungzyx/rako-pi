...
def build_user_message(
    ...
    return (
        ...
        "- Si el usuario dice que va a empezar una tarea, sugiere iniciar un bloque de foco/Pomodoro.\n"
        "- Da una sugerencia accionable para empezar ahora, evitando listas largas.\n"
        "- Sé cálido pero también directivo: una recomendación concreta vale más que motivación genérica.\n"
