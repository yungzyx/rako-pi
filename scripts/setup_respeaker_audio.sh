...
amixer -c "$CARD" sset 'Capture' 50 unmute >/dev/null
amixer -c "$CARD" sset 'ADC PCM' 210 >/dev/null
...
amixer -c "$CARD" sset 'ALC Max Gain' 6 >/dev/null
amixer -c "$CARD" sset 'ALC Target' 6 >/dev/null
